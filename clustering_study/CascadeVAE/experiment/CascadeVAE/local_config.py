...
ID_STRUCTURE_DICT = {
        'CascadeVAE' : ('nbatch', 'nconti', 'ncat', 'ntime', 'plamb',
                        'beta_min', 'beta_max', 'dptype', 'rseed')}
...
def local_dsprites_parser():
    ...
    parser.add_argument("--nconti", default = 3, help="the dimension of continuous representation", type = int)
    parser.add_argument("--ncat", default = 92, help="size of categorical data", type = int)
    parser.add_argument("--ntime", default = 1, help="When does discrete variable to be learned", type = int)
    return parser
