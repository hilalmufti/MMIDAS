...
DECAY_PARAMS_DICT =\
    ...
    'stair' : 
        {
           5000 :{
                'a1' : {'initial_lr' : 1e-3, 'decay_steps' : 50000,
                        'decay_rate' : 0.3},
                'a2' : {'initial_lr' : 3e-3, 'decay_steps' : 50000,
                        'decay_rate' : 0.3},
                'a3' : {'initial_lr' : 1e-3, 'decay_steps' : 50000,
                        'decay_rate' : 0.3},
                'a4' : {'initial_lr' : 3e-3, 'decay_steps' : 50000,
                        'decay_rate' : 0.3},
                'a5' : {'initial_lr' : 1e-2, 'decay_steps' : 50000,
                        'decay_rate' : 0.3}
                }
        }
    }
