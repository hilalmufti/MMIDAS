...
from modules.cellType.analysis_tree_helpers import parse_dend, get_ancestors
...
def dent_plot(treeobj, cluster_per_cat):
    ...
    # fig, (ax, cbar_ax) = plt.subplots(2, gridspec_kw=grid_kws, figsize=(8, 6))
    ...
    mask = 0 * cluster_per_cat
    mask[cluster_per_cat == 0] = True
    ...
    #                   yticklabels=False,vmin=0, vmax=.1,
    #                   annot_kws={"size": 18},
    #                   cbar_kws={"orientation": "horizontal", "ticks":[0.0,
    #                                                                   0.1]})

    axx.invert_yaxis()
    axx.set_facecolor('xkcd:white')
